...
define([
	...
	zoo.execute({
	    ...
	    dataInputs: [
		{"identifier": "table","value": tableName,"dataType":"string"},
		{"identifier": "territories_groups_in", value: "t_id",dataType: "string"},
		{"identifier": "territories_groups_out", value: "g_id",dataType: "string"},
		{"identifier": "t_hierarchy_in", value: "o_t_id",dataType: "string"},
		{"identifier": "t_hierarchy_out", value: "p_t_id",dataType: "string"},
	...
	$('#listElements').DataTable( {
		...
		var opts=zoo.getRequest({
			...
			{"identifier":"table","value":"mm.territories","dataType":"string"},
		...
		opts["error"]=function(){
		    console.log(arguments);
		    var data=_x2js.xml2json(arguments[0].responseXML);
		    $(".notifications").notify({
			message: { text: data["ExceptionReport"]["Exception"]["ExceptionText"].toString() },
			type: 'danger',
		    }).show();
