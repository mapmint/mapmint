...
__CHEETAH_genTime__ = 1447545835.509884
__CHEETAH_genTimestamp__ = 'Sun Nov 15 01:03:55 2015'
__CHEETAH_src__ = '/Users/djay/Sites/progede2/mapmint-ui/templates/Skeleton_bs.tmpl'
__CHEETAH_srcLastModified__ = 'Sun Nov 15 01:03:53 2015'
...
''')
        if VFFSL(SL,"istyles",True) is not None: # generated from line 41, col 1
            _v = VFFSL(SL,"istyles",True) # u'$istyles' on line 42, col 1
            if _v is not None: write(_filter(_v, rawExpr=u'$istyles')) # from line 42, col 1.
            write(u'''
''')
        write(u'''
<link href="''')
...
<body>
''')
        if VFFSL(SL,"mmodule",True)!="public": # generated from line 49, col 1
            if (VFN(VFN(VFFSL(SL,"conf",True),"keys",False)(),"count",False)("senv")>0 and VFN(VFN(VFFSL(SL,"conf",True)["senv"],"keys",False)(),"count",False)("loggedin")>0 and VFN(VFN(VFFSL(SL,"conf",True)["senv"],"keys",False)(),"count",False)("lastname")>0 and VFFSL(SL,"conf",True)["senv"]["loggedin"]!="false") and not(VFFSL(SL,"verr",True)): # generated from line 50, col 1
  ...
  <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="margin-bottom: 0">
   <div class="navbar-header">
     ...
     <a class="navbar-brand" href="#"><i class="fa fa-''')
                _v = VFFSL(SL,"lfonts",True)[VFN(VFFSL(SL,"mmodule",True),"lower",False)()] # u'$lfonts[$mmodule.lower()]' on line 72, col 55
                if _v is not None: write(_filter(_v, rawExpr=u'$lfonts[$mmodule.lower()]')) # from line 72, col 55.
                write(u'''"></i> <span class="hid">''')
                _v = VFN(VFFSL(SL,"zoo",True),"_",False)(VFFSL(SL,"mmodule",True)) # u'$zoo._($mmodule)' on line 72, col 105
                if _v is not None: write(_filter(_v, rawExpr=u'$zoo._($mmodule)')) # from line 72, col 105.
                write(u'''</span></a>
   </div>
   <!-- /.navbar-header -->
...
''')
                if VFFSL(SL,"admin_menu",True) is not None: # generated from line 77, col 1
                    write(u'''    ''')
                    _v = VFFSL(SL,"admin_menu",True) # u'$admin_menu' on line 78, col 5
                    if _v is not None: write(_filter(_v, rawExpr=u'$admin_menu')) # from line 78, col 5.
                    write(u'''
''')
...
\t <li><a href="#" id="mmmUserPreferences"><i class="fa fa-user fa-fw"></i> User Profile</a>
\t </li>
\t <li class="divider"></li>
\t <li><a href="#" id="mmmUserLogOut"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
\t </li>
       </ul>
       <!-- /.dropdown-user -->
     </li>
...
\t    
''')
                if VFFSL(SL,"conf",True)["main"]["indicators"]=="true": # generated from line 95, col 1
                    menu = ['Dashboard','Distiller','Territories','Indicators','Themes','Documents','Manager','Publisher']
                else: # generated from line 97, col 1
                    if VFFSL(SL,"conf",True)["mm"]["documents"]=="true": # generated from line 98, col 1
...
''')
                for a in VFFSL(SL,"menu",True): # generated from line 110, col 1
                    write(u'''\t      <li ''')
                    if VFFSL(SL,"inputs",True)['tmpl']['value']==VFFSL(SL,"a",True)+"_bs": # generated from line 111, col 12
                        write(u'''class="active"''')
                    write(u'''>
\t      <a href="''')
                    if VFFSL(SL,"inputs",True)['tmpl']['value']==VFFSL(SL,"a",True)+"_bs": # generated from line 112, col 17
                        write(u'''#" class="active"''')
                    else: # generated from line 112, col 74
                        write(u'''./''')
                        _v = VFFSL(SL,"a",True) # u'$(a)' on line 112, col 82
                        if _v is not None: write(_filter(_v, rawExpr=u'$(a)')) # from line 112, col 82.
                        write(u'''_bs"''')
                    write(u'''><i class="fa fa-''')
                    _v = VFFSL(SL,"lfonts",True)[a.lower()] # u'$(lfonts[a.lower()])' on line 112, col 115
                    if _v is not None: write(_filter(_v, rawExpr=u'$(lfonts[a.lower()])')) # from line 112, col 115.
                    write(u''' fa-fw"></i> ''')
                    _v = VFN(VFFSL(SL,"zoo",True),"_",False)(VFFSL(SL,"a",True)) # u'$zoo._($a)' on line 112, col 148
                    if _v is not None: write(_filter(_v, rawExpr=u'$zoo._($a)')) # from line 112, col 148.
                    write(u'''
''')
                    if VFFSL(SL,"mmenu",True) is not None and VFFSL(SL,"inputs",True)['tmpl']['value']==VFFSL(SL,"a",True)+"_bs": # generated from line 113, col 1
                        write(u'''<span class="fa arrow"></span>
\t      </a>
\t      ''')
                        _v = VFFSL(SL,"mmenu",True) # u'$mmenu' on line 116, col 8
                        if _v is not None: write(_filter(_v, rawExpr=u'$mmenu')) # from line 116, col 8.
                        write(u'''
''')
...
''')
                    write(u'''\t      </li>
''')
                if VFN(VFFSL(SL,"menu",True),"count",False)(VFN(VFFSL(SL,"inputs",True)['tmpl']['value'],"replace",False)("_bs",""))==0: # generated from line 122, col 1
                    write(u'''\t      ''')
                    _v = VFFSL(SL,"mmenu",True) # u'$mmenu' on line 123, col 8
                    if _v is not None: write(_filter(_v, rawExpr=u'$mmenu')) # from line 123, col 8.
                    write(u'''
''')
                write(u'''
\t    </ul>
...
''')
        write(u'''
''')
        _v = VFFSL(SL,"body",True) # u'$body' on line 139, col 1
        if _v is not None: write(_filter(_v, rawExpr=u'$body')) # from line 139, col 1.
        write(u'''

''')
        if VFFSL(SL,"tfooter",True) is not None: # generated from line 141, col 1
            _v = VFFSL(SL,"tfooter",True) # u'$tfooter' on line 142, col 1
            if _v is not None: write(_filter(_v, rawExpr=u'$tfooter')) # from line 142, col 1.
            write(u'''
''')
        write(u'''\t</div>
''')
        if VFFSL(SL,"mmodule",True)!="public" and (VFN(VFN(VFFSL(SL,"conf",True),"keys",False)(),"count",False)("senv")>0 and VFFSL(SL,"conf",True)["senv"]["loggedin"]!="false" and VFN(VFN(VFFSL(SL,"conf",True)["senv"],"keys",False)(),"count",False)("firstname")>0) and not(VFFSL(SL,"verr",True)): # generated from line 145, col 1
            write(u'''<div class="ui-layout-south hide"></div>
''')
        else: # generated from line 147, col 1
            if VFN(VFN(VFFSL(SL,"conf",True)["mm"],"keys",False)(),"count",False)("nofooter")==0 or (VFFSL(SL,"conf",True)["mm"]["nofooter"]!="true" and VFN(VFN(VFFSL(SL,"conf",True)["mm"],"keys",False)(),"count",False)("nofooter")>0): # generated from line 148, col 1
                write(u'''<footer>
  <div class="container text-center">
''')
                d = datetime.today()
                write(u'''    <p>Copyright &copy; <a href="''')
                _v = VFFSL(SL,"conf",True)["provider"]["providerSite"] # u'$conf["provider"]["providerSite"]' on line 153, col 34
                if _v is not None: write(_filter(_v, rawExpr=u'$conf["provider"]["providerSite"]')) # from line 153, col 34.
                write(u'''">''')
                _v = VFFSL(SL,"conf",True)["provider"]["providerName"] # u'$conf["provider"]["providerName"]' on line 153, col 69
                if _v is not None: write(_filter(_v, rawExpr=u'$conf["provider"]["providerName"]')) # from line 153, col 69.
                write(u'''</a> ''')
                _v = VFFSL(SL,"d.year",True) # u'$d.year' on line 153, col 107
                if _v is not None: write(_filter(_v, rawExpr=u'$d.year')) # from line 153, col 107.
                write(u'''</p>
  </div>
</footer>
''')
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        _v = VFN(VFFSL(SL,"zoo",True),"_",False)("User Settings") # u'$zoo._("User Settings")' on line 170, col 82
        if _v is not None: write(_filter(_v, rawExpr=u'$zoo._("User Settings")')) # from line 170, col 82.
        write(u''' </h4>
      </div>
...
<script data-main="''')
        _v = VFFSL(SL,"conf",True)["main"]["mmAddress"] # u'$conf["main"]["mmAddress"]' on line 180, col 20
        if _v is not None: write(_filter(_v, rawExpr=u'$conf["main"]["mmAddress"]')) # from line 180, col 20.
        write(u'''/admin;module=''')
        _v = VFFSL(SL,"mmodule",True) # u'$mmodule' on line 180, col 60
        if _v is not None: write(_filter(_v, rawExpr=u'$mmodule')) # from line 180, col 60.
        write(u'''" src="''')
        _v = VFFSL(SL,"conf",True)["main"]["publicationUrl"] # u'$conf["main"]["publicationUrl"]' on line 180, col 75
        if _v is not None: write(_filter(_v, rawExpr=u'$conf["main"]["publicationUrl"]')) # from line 180, col 75.
