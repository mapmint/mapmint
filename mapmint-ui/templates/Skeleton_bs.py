...
__CHEETAH_genTime__ = 1476105417.330139
__CHEETAH_genTimestamp__ = 'Mon Oct 10 15:16:57 2016'
__CHEETAH_src__ = '/Users/djay/Sites/progede2/mapmint-ui/templates/Skeleton_bs.tmpl'
__CHEETAH_srcLastModified__ = 'Mon Oct 10 15:16:51 2016'
...
''')
                try: # generated from line 84, col 1
                    ...
                    cfont = "question"
                if VFFSL(SL,"mmodule",True)=="tables-public": # generated from line 89, col 1
                    write(u'''     <a class="navbar-brand" href="#"><i class="fa fa-''')
                    _v = VFFSL(SL,"cfont",True) # u'$cfont' on line 90, col 55
                    if _v is not None: write(_filter(_v, rawExpr=u'$cfont')) # from line 90, col 55.
                    write(u'''"></i> <span class="hid">''')
                    _v = VFN(VFFSL(SL,"zoo",True),"_",False)("Data import") # u'$zoo._("Data import")' on line 90, col 86
                    if _v is not None: write(_filter(_v, rawExpr=u'$zoo._("Data import")')) # from line 90, col 86.
                    write(u'''</span></a>
''')
                else: # generated from line 91, col 1
                    write(u'''     <a class="navbar-brand" href="#"><i class="fa fa-''')
                    _v = VFFSL(SL,"cfont",True) # u'$cfont' on line 92, col 55
                    if _v is not None: write(_filter(_v, rawExpr=u'$cfont')) # from line 92, col 55.
                    write(u'''"></i> <span class="hid">''')
                    _v = VFN(VFFSL(SL,"zoo",True),"_",False)(VFFSL(SL,"mmodule",True)) # u'$zoo._($mmodule)' on line 92, col 86
                    if _v is not None: write(_filter(_v, rawExpr=u'$zoo._($mmodule)')) # from line 92, col 86.
                    write(u'''</span></a>
''')
                write(u'''   </div>
   <!-- /.navbar-header -->
...
''')
                if VFFSL(SL,"admin_menu",True) is not None: # generated from line 98, col 1
                    write(u'''    ''')
                    _v = VFFSL(SL,"admin_menu",True) # u'$admin_menu' on line 99, col 5
                    if _v is not None: write(_filter(_v, rawExpr=u'$admin_menu')) # from line 99, col 5.
                    write(u'''
''')
...
\t <li><a href="#" id="mmmUserPreferences"><i class="fa fa-user fa-fw"></i> ''')
                _v = VFN(VFFSL(SL,"zoo",True),"_",False)("User Profile") # u'$zoo._("User Profile")' on line 106, col 76
                if _v is not None: write(_filter(_v, rawExpr=u'$zoo._("User Profile")')) # from line 106, col 76.
                write(u'''</a>
\t </li>
\t <li class="divider"></li>
\t <li><a href="#" id="mmmUserLogOut"><i class="fa fa-sign-out fa-fw"></i> ''')
                _v = VFN(VFFSL(SL,"zoo",True),"_",False)("Logout") # u'$zoo._("Logout")' on line 109, col 75
                if _v is not None: write(_filter(_v, rawExpr=u'$zoo._("Logout")')) # from line 109, col 75.
                write(u'''</a>
\t </li>
       </ul>
       <!-- /.dropdown-user -->
...
''')
                if VFFSL(SL,"mmenu0",True) is None: # generated from line 116, col 1
                    if VFN(VFN(VFFSL(SL,"conf",True)["mm"],"keys",False)(),"count",False)('indicators')>0 and VFFSL(SL,"conf",True)["main"]["indicators"]=="true": # generated from line 117, col 1
                        menu = ['Dashboard','Distiller','Territories','Indicators','Themes','Documents','Manager','Publisher']
                    else: # generated from line 119, col 1
                        if VFN(VFN(VFFSL(SL,"conf",True)["mm"],"keys",False)(),"count",False)('indicators')>0 and VFFSL(SL,"conf",True)["mm"]["documents"]=="true": # generated from line 120, col 1
                    ...
                    if VFN(VFN(VFFSL(SL,"conf",True)["mm"],"keys",False)(),"count",False)('tables')>0 and VFFSL(SL,"conf",True)["mm"]["tables"]=="true": # generated from line 126, col 1
                        mmenu0 = []
                        for a in range(0,len(VFFSL(SL,"menu",True))): # generated from line 128, col 1
                            mmenu0 += [VFFSL(SL,"menu",True)[a]]
                            if a==4: # generated from line 130, col 1
                                mmenu0 += ["Tables"]
                ...
                write(u'''
''')
                if VFN(VFN(VFFSL(SL,"conf",True)["mm"],"keys",False)(),"count",False)('importers')>0 and VFFSL(SL,"conf",True)["mm"]["importers"]=="true": # generated from line 140, col 1
                    mmenu0 = []
                    for a in range(0,len(VFFSL(SL,"menu",True))): # generated from line 142, col 1
                        mmenu0 += [VFFSL(SL,"menu",True)[a]]
                        if a==5: # generated from line 144, col 1
                            mmenu0 += ["Importers"]
                    menu = VFFSL(SL,"mmenu0",True)
                write(u'''
...
''')
                for a in VFFSL(SL,"menu",True): # generated from line 155, col 1
                    write(u'''\t      <li ''')
                    if VFFSL(SL,"inputs",True)['tmpl']['value']==VFFSL(SL,"a",True)+"_bs": # generated from line 156, col 12
                        write(u'''class="active"''')
                    write(u'''>
\t      <a href="''')
                    if VFFSL(SL,"inputs",True)['tmpl']['value']==VFFSL(SL,"a",True)+"_bs": # generated from line 157, col 17
                        write(u'''#" class="active"''')
                    else: # generated from line 157, col 74
                        write(u'''./''')
                        _v = VFFSL(SL,"a",True) # u'$(a)' on line 157, col 82
                        if _v is not None: write(_filter(_v, rawExpr=u'$(a)')) # from line 157, col 82.
                        write(u'''_bs"''')
                    write(u'''><i class="fa fa-''')
                    _v = VFFSL(SL,"lfonts",True)[a.lower()] # u'$(lfonts[a.lower()])' on line 157, col 115
                    if _v is not None: write(_filter(_v, rawExpr=u'$(lfonts[a.lower()])')) # from line 157, col 115.
                    write(u''' fa-fw"></i> ''')
                    _v = VFN(VFFSL(SL,"zoo",True),"_",False)(VFFSL(SL,"a",True)) # u'$zoo._($a)' on line 157, col 148
                    if _v is not None: write(_filter(_v, rawExpr=u'$zoo._($a)')) # from line 157, col 148.
                    write(u'''
''')
                    if VFFSL(SL,"mmenu",True) is not None and VFFSL(SL,"inputs",True)['tmpl']['value']==VFFSL(SL,"a",True)+"_bs": # generated from line 158, col 1
                        write(u'''<span class="fa arrow"></span>
\t      </a>
\t      ''')
                        _v = VFFSL(SL,"mmenu",True) # u'$mmenu' on line 161, col 8
                        if _v is not None: write(_filter(_v, rawExpr=u'$mmenu')) # from line 161, col 8.
                        write(u'''
''')
                    else	      : # generated from line 162, col 1
                        write(u'''\t      </a>
''')
                    write(u'''\t      </li>
''')
                if VFN(VFFSL(SL,"menu",True),"count",False)(VFN(VFFSL(SL,"inputs",True)['tmpl']['value'],"replace",False)("_bs",""))==0: # generated from line 167, col 1
                    write(u'''\t      ''')
                    _v = VFFSL(SL,"mmenu",True) # u'$mmenu' on line 168, col 8
                    if _v is not None: write(_filter(_v, rawExpr=u'$mmenu')) # from line 168, col 8.
                    write(u'''
''')
                write(u'''
\t    </ul>
...
''')
        write(u'''
''')
        _v = VFFSL(SL,"body",True) # u'$body' on line 184, col 1
        if _v is not None: write(_filter(_v, rawExpr=u'$body')) # from line 184, col 1.
        write(u'''

''')
        if VFFSL(SL,"tfooter",True) is not None: # generated from line 186, col 1
            _v = VFFSL(SL,"tfooter",True) # u'$tfooter' on line 187, col 1
            if _v is not None: write(_filter(_v, rawExpr=u'$tfooter')) # from line 187, col 1.
            write(u'''
''')
        write(u'''\t</div>
''')
        if VFFSL(SL,"mmodule",True)!="public" and (VFN(VFN(VFFSL(SL,"conf",True),"keys",False)(),"count",False)("senv")>0 and VFFSL(SL,"conf",True)["senv"]["loggedin"]!="false" and VFN(VFN(VFFSL(SL,"conf",True)["senv"],"keys",False)(),"count",False)("firstname")>0) and not(VFFSL(SL,"verr",True)): # generated from line 190, col 1
            write(u'''<div class="ui-layout-south hide"></div>
''')
        else: # generated from line 192, col 1
            if VFN(VFN(VFFSL(SL,"conf",True)["mm"],"keys",False)(),"count",False)("nofooter")==0 or (VFFSL(SL,"conf",True)["mm"]["nofooter"]!="true" and VFN(VFN(VFFSL(SL,"conf",True)["mm"],"keys",False)(),"count",False)("nofooter")>0): # generated from line 193, col 1
                write(u'''<footer>
  <div class="container text-center">
''')
                d = datetime.today()
                write(u'''    <p>Copyright &copy; <a href="''')
                _v = VFFSL(SL,"conf",True)["provider"]["providerSite"] # u'$conf["provider"]["providerSite"]' on line 198, col 34
                if _v is not None: write(_filter(_v, rawExpr=u'$conf["provider"]["providerSite"]')) # from line 198, col 34.
                write(u'''">''')
                _v = VFFSL(SL,"conf",True)["provider"]["providerName"] # u'$conf["provider"]["providerName"]' on line 198, col 69
                if _v is not None: write(_filter(_v, rawExpr=u'$conf["provider"]["providerName"]')) # from line 198, col 69.
                write(u'''</a> ''')
                _v = VFFSL(SL,"d.year",True) # u'$d.year' on line 198, col 107
                if _v is not None: write(_filter(_v, rawExpr=u'$d.year')) # from line 198, col 107.
                write(u'''</p>
  </div>
</footer>
''')
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        _v = VFN(VFFSL(SL,"zoo",True),"_",False)("User Settings") # u'$zoo._("User Settings")' on line 215, col 82
        if _v is not None: write(_filter(_v, rawExpr=u'$zoo._("User Settings")')) # from line 215, col 82.
        write(u''' </h4>
      </div>
...
<script data-main="''')
        _v = VFFSL(SL,"conf",True)["main"]["mmAddress"] # u'$conf["main"]["mmAddress"]' on line 225, col 20
        if _v is not None: write(_filter(_v, rawExpr=u'$conf["main"]["mmAddress"]')) # from line 225, col 20.
        write(u'''/admin;module=''')
        _v = VFFSL(SL,"mmodule",True) # u'$mmodule' on line 225, col 60
        if _v is not None: write(_filter(_v, rawExpr=u'$mmodule')) # from line 225, col 60.
        write(u'''" src="''')
        _v = VFFSL(SL,"conf",True)["main"]["publicationUrl"] # u'$conf["main"]["publicationUrl"]' on line 225, col 75
        if _v is not None: write(_filter(_v, rawExpr=u'$conf["main"]["publicationUrl"]')) # from line 225, col 75.
