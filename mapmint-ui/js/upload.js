function startUploadWindow(){
  $.ajax({
        type: "GET",
	url: System.zooUrl+"?metapath=upload&service=WPS&version=1.0.0&request=Execute&Identifier=getForm&DataInputs=form=Upload&RawDataOutput=Result",
	dataType: 'xml',
...
function startUploadForm(){
  // Setup html5 version
	...
	// General settings
        runtimes : 'html5',
	url : System.zooUrl+'?metapath=upload&service=WPS&version=1.0.0&request=Execute&Identifier=saveOnServer&dataInputs=file=upload;dest='+$("#upload_dest")[0].value,
	max_file_size : '10mb',
	chunk_size : '10mb',
	unique_names : true
    };
...
function startCheck(){
  $.ajax({
        type: "GET",
	url: System.zooUrl+"?metapath=upload&service=WPS&version=1.0.0&request=Execute&Identifier=checkFile&DataInputs=dest="+$("#upload_dest")[0].value+"&RawDataOutput=Result",
	dataType: 'xml',
	complete:function(xml,status){
	  $("#uploader").html("");
	  var list="";
