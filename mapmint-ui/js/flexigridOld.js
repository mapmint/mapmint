...
(function($){
	...
	$.addFlex = function(t,p)
	{
		...
		var g = {
		  ...
		  { name : 'DataInputs', value : "getFeatures=true;dataSource="+p.dwDataSource+";layer="+p.dwLayer+";page="+p.newp+";limit="+p.limit+";sortname="+p.sortname+";sortorder="+p.sortorder+";encoding="+$mj("swenc_"+p.id).value },
		...
		if (p.title)
		{
			...
			g.mDiv.innerHTML = '<div class="ftitle">'+'<img src="images/'+p.dwDataType+'.png" alt="'+p.dwDataType+'" /><span style="padding-left: 10px;position:absolute;top:6px;">'+p.title+'</span></div>';
