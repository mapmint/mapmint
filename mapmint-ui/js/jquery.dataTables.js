...
(function($, window, document) {
	...
	_oExt.oJUIClasses = {
		/* Two buttons buttons */
		"sPagePrevEnabled": "fg-button2 ui-button ui-state-default ui-corner-left",
		"sPagePrevDisabled": "fg-button2 ui-button ui-state-default ui-corner-left ui-state-disabled",
		"sPageNextEnabled": "fg-button2 ui-button ui-state-default ui-corner-right",
		"sPageNextDisabled": "fg-button2 ui-button ui-state-default ui-corner-right ui-state-disabled",
		"sPageJUINext": "ui-icon ui-icon-circle-arrow-e",
		"sPageJUIPrev": "ui-icon ui-icon-circle-arrow-w",
		
		/* Full numbers paging buttons */
		"sPageButton": "fg-button2 ui-button ui-state-default",
		"sPageButtonActive": "fg-button2 ui-button ui-state-default ui-state-disabled",
		"sPageButtonStaticDisabled": "fg-button2 ui-button ui-state-default ui-state-disabled",
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			 ...
			 */
			this._iDisplayLength = 15;
			this._iDisplayStart = 0;
			this._iDisplayEnd = 15;
			...
			for ( var i=0 ; i<aDom.length ; i++ )
			{
				...
				if ( cOption == '<' )
				{
					...
					if ( cNext == "'" || cNext == '"' )
					{
						...
						if ( sAttr == "F" )
						{
							sAttr = "fg-toolbar ui-toolbar ui-widget-header ui-helper-clearfix";
						}
