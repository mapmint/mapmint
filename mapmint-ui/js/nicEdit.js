...
var nicEditorConfig = bkClass.extend({
	...
	iconsPath : 'http://localhost/~djay/mm2/mapmint-ui/img/nicEditorIcons.gif',
...
var nicEditorPane = bkClass.extend({
	construct : function(elm,nicEditor,options,openButton) {
		...
		this.pane = new bkElement('div').setStyle({fontSize : '12px', border : '1px solid #ccc', 'overflow': 'hidden', padding : '4px', textAlign: 'left', backgroundColor : '#808080', fontSize:".8em"}).addClass('pane').setStyle(options).appendTo(this.contain);
...
var nicButtonTips = bkClass.extend({
	...
	create : function(button) {
		this.timer = null;
		if(!this.pane) {
			this.pane = new nicEditorPane(button.button,this.ne,{fontSize : '10px', marginTop : '5px'});
...
var nicEditorSelect = bkClass.extend({
	...
	construct : function(e,buttonName,options,nicEditor) {
		...
		this.txt = new bkElement('div').setStyle({overflow : 'hidden', 'float' : 'left', width : '66px', height : '14px', marginTop : '1px', textAlign : 'center', fontSize : '10px'}).addClass('selectTxt').appendTo(this.items);
