...
},plugins:["edraggable","droppable","resizable","pagination","tooltip","linkbutton","emenu","menubutton","splitbutton","progressbar","tree","combobox","combotree","combogrid","numberbox","validatebox","searchbox","numberspinner","timespinner","calendar","datebox","datetimebox","eslider","layout","panel","datagrid","propertygrid","treegrid","tabs","accordion","window","dialog"],parse:function(_2){
var aa=[];
...
_15(e,"mousedown");
if($.fn.edraggable.isDragging||$.fn.resizable.isResizing){
e.preventDefault();
}
};
function _16(e){
...
(function($){
function _1b(e){
var _1c=$.data(e.data.target,"edraggable");
var _1d=_1c.options;
var _1e=_1c.proxy;
var _1f=e.data;
...
function _21(e){
var _22=$.data(e.data.target,"edraggable");
var _23=_22.options;
var _24=_22.proxy;
if(!_24){
_24=$(e.data.target);
...
function _25(e){
$.fn.edraggable.isDragging=true;
var _26=$.data(e.data.target,"edraggable");
var _27=_26.options;
...
function _2b(e){
var _2c=$.data(e.data.target,"edraggable");
_1b(e);
...
function _2f(e){
$.fn.edraggable.isDragging=false;
_2b(e);
var _30=$.data(e.data.target,"edraggable");
var _31=_30.proxy;
var _32=_30.options;
if(_32.revert){
if(_33()==true){
...
$.fn.edraggable=function(_38,_39){
if(typeof _38=="string"){
return $.fn.edraggable.methods[_38](this,_39);
}
return this.each(function(){
var _3a;
var _3b=$.data(this,"edraggable");
if(_3b){
_3b.handle.unbind(".edraggable");
_3a=$.extend(_3b.options,_38);
}else{
_3a=$.extend({},$.fn.edraggable.defaults,$.fn.edraggable.parseOptions(this),_38||{});
}
var _3c=_3a.handle?(typeof _3a.handle=="string"?$(_3a.handle,this):_3a.handle):$(this);
$.data(this,"edraggable",{options:_3a,handle:_3c});
if(_3a.disabled){
$(this).css("cursor","");
return;
}
_3c.unbind(".edraggable").bind("mousemove.edraggable",{target:this},function(e){
if($.fn.edraggable.isDragging){
return;
}
var _3d=$.data(e.data.target,"edraggable").options;
if(_3e(e)){
$(this).css("cursor",_3d.cursor);
}else{
$(this).css("cursor","");
}
}).bind("mouseleave.edraggable",{target:this},function(e){
$(this).css("cursor","");
}).bind("mousedown.edraggable",{target:this},function(e){
if(_3e(e)==false){
return;
}
$(this).css("cursor","");
...
$.extend(e.data,_41);
var _42=$.data(e.data.target,"edraggable").options;
if(_42.onBeforeDrag.call(e.data.target,e)==false){
return;
}
$(document).bind("mousedown.edraggable",e.data,_25);
$(document).bind("mousemove.edraggable",e.data,_2b);
$(document).bind("mouseup.edraggable",e.data,_2f);
});
function _3e(e){
var _43=$.data(e.data.target,"edraggable");
var _44=_43.handle;
var _45=$(_44).offset();
...
$.fn.edraggable.methods={options:function(jq){
return $.data(jq[0],"edraggable").options;
},proxy:function(jq){
return $.data(jq[0],"edraggable").proxy;
},enable:function(jq){
return jq.each(function(){
$(this).edraggable({disabled:false});
});
},disable:function(jq){
return jq.each(function(){
$(this).edraggable({disabled:true});
});
}};
$.fn.edraggable.parseOptions=function(_48){
var t=$(_48);
...
$.fn.edraggable.defaults={proxy:null,revert:false,cursor:"move",deltaX:null,deltaY:null,handle:null,disabled:false,edge:0,axis:null,onBeforeDrag:function(e){
...
var _b5=$(this);
var _b6=$.extend({},$.parser.parseOptions(this,["id","iconCls","state"]),{checked:(_b5.prop("checked")?true:undefined)});
...
var _c8=_c6.tree;
_c6.disabledNodes=[];
_c8.find("div.tree-node").edraggable({disabled:false,revert:true,cursor:"pointer",proxy:function(_c9){
...
$(this).edraggable("proxy").css({left:-10000,top:-10000});
...
var _db=$(_d9).edraggable("proxy").find("span.tree-dnd-icon");
...
_23b.window.edraggable({handle:">div.panel-header>div.panel-title",disabled:_23b.options.edraggable==false,onStartDrag:function(e){
if(_23b.mask){
...
return $.extend({},$.fn.panel.parseOptions(_244),$.parser.parseOptions(_244,[{edraggable:"boolean",resizable:"boolean",shadow:"boolean",modal:"boolean",inline:"boolean"}]));
};
$.fn.window.defaults=$.extend({},$.fn.panel.defaults,{zIndex:9000,edraggable:true,resizable:true,shadow:true,modal:false,inline:false,title:"New Window",collapsible:true,minimizable:true,maximizable:true,closable:true,closed:false});
})(jQuery);
(function($){
function _245(_246){
...
function _262(_263){
var opts=$.extend({},$.fn.window.defaults,{collapsible:false,minimizable:false,maximizable:false,shadow:false,edraggable:false,resizable:false,closed:true,style:{left:"",top:"",right:0,zIndex:$.fn.window.defaults.zIndex++,bottom:-document.body.scrollTop-document.documentElement.scrollTop},onBeforeOpen:function(){
...
$("body>div.menu-top:visible").emenu("hide");
});
var _378=_379($(_376));
...
var opts=$.data(_383,"emenu").options;
...
var item=$(_388).emenu("getItem",this);
$.data(_388,"emenu").options.onClick.call(_388,item);
...
if(_389){
$(_388).emenu("show",{emenu:_389,parent:item});
}
}).bind("mouseleave.emenu",function(e){
...
var left,top;
_390=_390||{};
var menu=$(_390.emenu||_38f);
if(menu.hasClass("menu-top")){
var opts=$.data(_38f,"emenu").options;
$.extend(opts,_390);
left=opts.left;
top=opts.top;
if(opts.alignTo){
...
menu[0].shadow.css({display:"block",zIndex:$.fn.emenu.defaults.zIndex++,left:menu.css("left"),top:menu.css("top"),width:menu.outerWidth(),height:menu.outerHeight()});
menu.css("z-index",$.fn.emenu.defaults.zIndex++);
if(menu.hasClass("menu-top")){
$.data(menu[0],"emenu").options.onShow.call(menu[0]);
}
});
};
function _38b(menu){
...
$.fn.emenu=function(_3a4,_3a5){
if(typeof _3a4=="string"){
return $.fn.emenu.methods[_3a4](this,_3a5);
}
_3a4=_3a4||{};
return this.each(function(){
var _3a6=$.data(this,"emenu");
if(_3a6){
$.extend(_3a6.options,_3a4);
}else{
_3a6=$.data(this,"emenu",{options:$.extend({},$.fn.emenu.defaults,$.fn.emenu.parseOptions(this),_3a4)});
init(this);
}
$(this).css({left:_3a6.options.left,top:_3a6.options.top});
});
};
$.fn.emenu.methods={options:function(jq){
return $.data(jq[0],"emenu").options;
...
return jq.each(function(){
var item=$(this).emenu("getItem",_3a8.target);
if(item.iconCls){
...
$.fn.emenu.parseOptions=function(_3ae){
return $.extend({},$.parser.parseOptions(_3ae,["left","top",{minWidth:"number"}]));
};
$.fn.emenu.defaults={zIndex:110000,left:0,top:0,minWidth:120,onShow:function(){
},onHide:function(){
...
if(opts.disabled||!opts.emenu){
return;
}
$("body>div.menu-top").emenu("hide");
var btn=$(_3ba);
var mm=$(opts.emenu);
if(mm.length){
mm.emenu("options").alignTo=btn;
mm.emenu("show",{alignTo:btn});
}
btn.blur();
};
...
var t=$(_3c1);
return $.extend({},$.fn.linkbutton.parseOptions(_3c1),$.parser.parseOptions(_3c1,["emenu",{plain:"boolean",duration:"number"}]));
};
$.fn.menubutton.defaults=$.extend({},$.fn.linkbutton.defaults,{plain:true,emenu:null,duration:100,cls:{btn1:"m-btn-active",btn2:"m-btn-plain-active",arrow:"m-btn-downarrow",trigger:"m-btn"}});
})(jQuery);
(function($){
function init(_3c2){
...
var t=$(_3c9);
return $.extend({},$.fn.linkbutton.parseOptions(_3c9),$.parser.parseOptions(_3c9,["emenu",{plain:"boolean",duration:"number"}]));
};
$.fn.splitbutton.defaults=$.extend({},$.fn.linkbutton.defaults,{plain:true,emenu:null,duration:100,cls:{btn1:"s-btn-active",btn2:"s-btn-plain-active",arrow:"s-btn-downarrow",trigger:"s-btn-downarrow"}});
})(jQuery);
(function($){
function init(_3ca){
$(_3ca).hide();
...
if(opts.emenu){
_3d4.emenu=$(opts.emenu).emenu({onClick:function(item){
_3d5(item);
}});
var item=_3d4.emenu.children("div.menu-item:first");
_3d4.emenu.children("div.menu-item").each(function(){
...
mb.prependTo(_3d4.searchbox).menubutton({emenu:_3d4.emenu,iconCls:item.iconCls});
...
return $.data(jq[0],"searchbox").emenu;
},textbox:function(jq){
...
return jq.each(function(){
var menu=$.data(this,"searchbox").emenu;
if(menu){
...
var t=$(_3e5);
return $.extend({},$.parser.parseOptions(_3e5,["width","height","prompt","emenu"]),{value:t.val(),searcher:(t.attr("searcher")?eval(t.attr("searcher")):undefined)});
};
$.fn.searchbox.defaults={width:"auto",height:22,prompt:"",value:"",emenu:null,searcher:function(_3e6,name){
}};
})(jQuery);
(function($){
function init(_3e7){
...
var _8d3=$.data(_8d1,"eslider");
var opts=_8d3.options;
var _8d4=_8d3.eslider;
if(_8d2){
if(_8d2.width){
...
function _8d6(_8d7){
var _8d8=$.data(_8d7,"eslider");
var opts=_8d8.options;
var _8d9=_8d8.eslider;
...
function _8dd(_8de){
var _8df=$.data(_8de,"eslider");
var opts=_8df.options;
var _8e0=_8df.eslider;
...
_8e0.find("a.slider-handle").edraggable({axis:opts.mode,cursor:"pointer",disabled:opts.disabled,onDrag:function(e){
...
var _8ea=$.data(_8e8,"eslider");
var opts=_8ea.options;
var _8eb=_8ea.eslider;
var _8ec=opts.value;
if(_8e9<opts.min){
_8e9=opts.min;
}
...
function _8d5(_8ef){
var opts=$.data(_8ef,"eslider").options;
var fn=opts.onChange;
opts.onChange=function(){
};
...
var _8f2=$.data(_8f0,"eslider");
var opts=_8f2.options;
var _8f3=_8f2.eslider;
if(opts.mode=="h"){
...
var _8f6=$.data(_8f5,"eslider");
var opts=_8f6.options;
var _8f7=_8f6.eslider;
if(opts.mode=="h"){
...
$.fn.eslider=function(_8f9,_8fa){
if(typeof _8f9=="string"){
return $.fn.eslider.methods[_8f9](this,_8fa);
}
_8f9=_8f9||{};
return this.each(function(){
var _8fb=$.data(this,"eslider");
if(_8fb){
$.extend(_8fb.options,_8f9);
}else{
_8fb=$.data(this,"eslider",{options:$.extend({},$.fn.eslider.defaults,$.fn.eslider.parseOptions(this),_8f9),eslider:init(this)});
$(this).removeAttr("disabled");
}
...
$.fn.eslider.methods={options:function(jq){
return $.data(jq[0],"eslider").options;
},destroy:function(jq){
return jq.each(function(){
$.data(this,"eslider").eslider.remove();
$(this).remove();
});
...
return jq.eslider("options").value;
...
return jq.each(function(){
$.data(this,"eslider").options.disabled=false;
_8dd(this);
});
},disable:function(jq){
return jq.each(function(){
$.data(this,"eslider").options.disabled=true;
_8dd(this);
});
}};
$.fn.eslider.parseOptions=function(_8fe){
var t=$(_8fe);
...
$.fn.eslider.defaults={width:"auto",height:"auto",mode:"h",reversed:false,showTip:false,disabled:false,value:0,min:0,max:100,step:1,rule:[],tipFormatter:function(_8ff){
return _8ff;
